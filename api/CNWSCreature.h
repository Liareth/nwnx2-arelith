...
public:
    ...
    /* 0x30c     */ unsigned long field_30C;
    /* 0x310     */ unsigned long UpdateCombatInformation;
    /* 0x488/1160 */ char rsvd3[372];
    ...
    /* 0x4AC/1196 */ unsigned char DetectMode;
    /* 0x4AD/1197 */ unsigned char StealthMode;
    /* 0x4AE/1198 */ unsigned char DefensiveCastingMode;
    /* 0x4AF/1199 */ unsigned char CombatMode;
    /* 0x4B0/1200 */ unsigned char DesiredCombatMode;
    /* 0x4B1/1201 */ unsigned char field_4B1;
    /* 0x4B2/1202 */ unsigned char field_4B2;
    /* 0x4B3/1203 */ unsigned char field_4B3;
    /* 0x4B4/1204 */ unsigned long CounterspellTarget;
    ...
    /* 0x4C0/1216 */ unsigned long CombatState;
    ...
    /* 0x4EC */      unsigned long field_4ec;
    /* 0x4F0 */      unsigned long field_4f0;
    /* 0x4F4 */      unsigned long field_4f4;
    /* 0x4F8/1272 */ unsigned long Attacker;
    /* 0x4FC/1276 */ unsigned long AttemptedSpell;
    /* 0x500 */      unsigned long SpellTarget;
    /* 0x504 */      unsigned long field_504;
    /* 0x508 */      unsigned long field_508;
    /* 0x50C */      unsigned long field_50c;
    /* 0x510 */      unsigned long BroadcastAOO;
    /* 0x514 */      unsigned long field_514;
    /* 0x518 */      unsigned long ExtCombatMode;
    /* 0x51C */      unsigned long EffectBonusAmounts[50];
    /* 0x5E4 */      unsigned long EffectPenaltyAmounts[50];
    /* 0x6AC */      unsigned long EffectBonusSpellIds[50];
    /* 0x774 */      unsigned long EffectPenaltySpellIds[50];
    /* 0x83C */      unsigned long EffectBonusObjectIds[50];
    /* 0x094 */      unsigned long EffectPenaltyObjectIds[50];
    /* 0x9CC      */ unsigned long IsSilent;
    /* 0x9D0      */ unsigned long Hasted;
    /* 0x9D4      */ unsigned long Slowed;
    /* 0x9D8      */ unsigned long Taunted;
    /* 0x9DC      */ unsigned long ForcedWalk;
    /* 0x9E0      */ char VisionType;
    /* 0x9E1      */ char State;
    /* 0x9E2      */ char field_9E2;
    /* 0x9E3      */ char field_9E3;
    /* 0x9E4      */ unsigned long CurrentSpell;
    /* 0x9E8      */ CExoArrayList<void *> EffectIcons;
    /* 0x9F4      */ unsigned long CutsceneCamMode;
    /* 0x9F8      */ unsigned long CutsceneCamMove;
    /* 0x9FC      */ unsigned long CutsceneInvuln;
    /* 0xA00      */ unsigned long CutsceneGhost;
    /* 0xA04      */ unsigned long LastPerceptionPerceived;
    /* 0xA08      */ unsigned long LastPerceptionHeard;
    /* 0xA0C      */ unsigned long LastPerceptionSeen;
    /* 0xA10      */ unsigned long LastPerceptionInaudible;
    /* 0xA14      */ unsigned long LastPerceptionVanished;
    /* 0xA18/2584 */ float SpotDistance;
    /* 0xA1C/2588 */ float SpotMaxDistance;
    /* 0xA20/2592 */ float ListenDistance;
    /* 0xA24/2596 */ float ListenMaxDistance;
    /* 0xA28/2600 */ float BlindsenseDistance;
    /* 0xA2C      */ char LastHideRoll;
    /* 0xA2D      */ char LastMoveSilentlyRoll;
    /* 0xA2E      */ char LastSpotRoll;
    /* 0xA2F      */ char LastListenRoll;
    /* 0xA30      */ CExoArrayList<CNWVisibilityNode*> PerceptionList;
    /* 0xa3c      */ unsigned long PartyInviter;
    /* 0xA40      */ unsigned long PartyInvited;
    /* 0xA44      */ unsigned long PartyInviteTime1;
    /* 0xA48      */ unsigned long PartyInviteTime2;
    /* 0xA4C      */ unsigned long PartyInvites;
    /* 0xA50      */ CExoArrayList<CNWSInvitationDetails>* IgnoredInvitationsList; // This appears to be a actual ptr to a cexolist. Not a mistake.
    /* 0xA54      */ unsigned long LockOrientation;
    /* 0xA58      */ unsigned long CounterspellId;
    /* 0xA5C      */ unsigned char CounterspellClass;
    /* 0xA5D      */ unsigned char CounterspellMeta;
    /* 0xA5E      */ unsigned char CounterspellDomain;
    /* 0xA5F      */ unsigned char field_A5F;
    /* 0xA60      */ CExoArrayList<unsigned long> SpellIdentifiedList;
    /* 0xA6C      */ unsigned long ItemSpellItem;
    /* 0xA70      */ unsigned long LastSpellUnreadied;
    /* 0xA74      */ unsigned long SpellItemId;
    /* 0xA78      */ unsigned long SpellItemLevel;
    /* 0xA7C      */ unsigned long SpellItemAOO;
    /* 0xA80      */ unsigned long SittingObject;
    /* 0xA84      */ unsigned long StealAnimationPlayed;
    /* 0xA88/2696 */ unsigned long StealDetected;
...
static_assert(sizeof(CNWSCreature) == 0xc74, "sizeof() wrong, you broke fields");
#endif
