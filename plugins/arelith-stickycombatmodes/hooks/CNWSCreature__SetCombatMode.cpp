...
std::unique_ptr<FunctionHook> Hooks::CNWSCreature__SetCombatMode::g_hookPtr;
...
void Hooks::CNWSCreature__SetCombatMode::Hook()
{
    g_hookPtr = std::make_unique<FunctionHook>(
        ...
        Functions::CNWSCreature__SetCombatMode,
        getFuncAddr(&CNWSCreature__SetCombatMode__Hook));
}
...
void Hooks::CNWSCreature__SetCombatMode__Hook(CNWSCreature* thisPtr, const uint8_t mode, const int32_t a2)
{
    ...
    g_hookPtr->callOriginal<CallingConvention::ThisCall, void>(thisPtr, mode, a2);
}
